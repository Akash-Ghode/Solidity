...
//  Since Solidity does not offer a native way to concatenate strings use abi.encodePacked() to do that. Read the official 
//  doc https://docs.soliditylang.org/en/latest/abi-spec.html for examples.
